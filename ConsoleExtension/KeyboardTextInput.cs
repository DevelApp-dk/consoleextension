...
namespace ConsoleExtension
{
    class KeyboardTextInput
    {
        ...
        internal static void TextInput(string textInput)
        {
            ...
            for (int i = 0; i < chars.Length; i++)
            {
                ...
                for (int sleepCounter = 0; sleepCounter < 500; sleepCounter += 1)
                {
    ...
    //    internal static void TextInput(string textInput)
    //    {
    //        if (textInput.Length > UInt32.MaxValue / 2)
    //        {
    ...
    //        foreach (char inputChar in textInput)
    //        {
    //            if (Char.IsUpper(inputChar))
    //            {
    //                inputList.Add(BuildShiftDown);
    //                inputList.Add(BuildInput(char.ToLower(inputChar)));
    //                inputList.Add(BuildInputKeyUp(char.ToLower(inputChar)));
    //                inputList.Add(BuildShiftUp);
    //            }
    //            else
    //            {
    //                bool shift = false;
    //                char buildChar = inputChar;
    //                switch(inputChar)
    //                {
    //                    case '_':
    //                        buildChar = '-';
    ...
    //                {
    //                    inputList.Add(BuildShiftDown);
    //                    inputList.Add(BuildInput(buildChar));
    //                    inputList.Add(BuildInputKeyUp(buildChar));
    //                    inputList.Add(BuildShiftUp);
    //                }
    //                else
    //                {
    ...
    //    private static INPUT BuildShiftDown
    //    {
    //        get
    //        {
    //            INPUT input = new INPUT();
    //            input.type = 1; // 1 = Keyboard Input
    //            input.U.ki.wVk = VirtualKeyShort.SHIFT;
    //            return input;
    //        }
    //    }

    //    private static INPUT BuildShiftUp
    //    {
    //        get
    //        {
    //            INPUT input = BuildShiftDown;
    //            input.U.ki.dwFlags = KEYEVENTF.KEYUP;
    //            return input;
    //        }
    //    }

    //    private static INPUT BuildInputKeyUp(char inputChar)
    //    {
    //        INPUT input = BuildInput(inputChar);
    //        input.U.ki.dwFlags = KEYEVENTF.KEYUP;
    //        return input;
    //    }

    //    private static INPUT BuildInput(char inputChar)
    //    {
    //        INPUT input = new INPUT();
    //        input.type = 1; // 1 = Keyboard Input
    ...
    //                break;
    //            case '1':
    //                input.U.ki.wScan = (ScanCodeShort)2;
    //                break;
    //            case '2':
    //                input.U.ki.wScan = (ScanCodeShort)3;
    //                break;
    //            case '3':
    //                input.U.ki.wScan = (ScanCodeShort)4;
    //                break;
    //            case '4':
    //                input.U.ki.wScan = (ScanCodeShort)5;
    //                break;
    //            case '5':
    //                input.U.ki.wScan = (ScanCodeShort)6;
    //                break;
    //            case '6':
    //                input.U.ki.wScan = (ScanCodeShort)7;
    //                break;
    //            case '7':
    //                input.U.ki.wScan = (ScanCodeShort)8;
    //                break;
    //            case '8':
    //                input.U.ki.wScan = (ScanCodeShort)9;
    //                break;
    //            case '9':
    //                input.U.ki.wScan = (ScanCodeShort)10;
    //                break;
    //            case 'a':
    ...
    //                break;
    //            case '-':
    //                input.U.ki.wScan = (ScanCodeShort)12;
    //                break;
    //            case '=':
    //                input.U.ki.wScan = (ScanCodeShort)13;
    //                break;
    //            case '[':
    ...
    //                break;
    //            case '\'':
    //                input.U.ki.wScan = (ScanCodeShort)40;
    //                break;
    //            case '\\':
    //                input.U.ki.wScan = (ScanCodeShort)43;
    //                break;
    //            case ',':
    //                input.U.ki.wScan = (ScanCodeShort)51;
    //                break;
    //            case '.':
    //                input.U.ki.wScan = (ScanCodeShort)52;
    //                break;
    //            case '/':
    //                input.U.ki.wScan = (ScanCodeShort)53;
    //                break;
    //            default:
    //                throw new Exception(string.Format("Char not supported: |{0}|", inputChar));
    //        }
    //        return input;
    //    }
