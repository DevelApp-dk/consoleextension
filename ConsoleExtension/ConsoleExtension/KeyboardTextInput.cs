    ...
    class KeyboardTextInput
    {
        internal static void TextInput(string textInput)
        {
            ...
            foreach (char inputChar in textInput)
            {
                ...
                {
                    inputList.Add(BuildInput(inputChar));
                    inputList.Add(BuildInputKeyUp(inputChar));
                }
            }
        ...
        private static INPUT BuildInput(char inputChar)
        {
            ...
            switch (inputChar)
            {
                ...
                case ' ':
                    ...
                    break;
                case '-':
                    input.U.ki.wVk = VirtualKeyShort.OEM_MINUS;
                    break;
                case '.':
                    input.U.ki.wVk = VirtualKeyShort.OEM_PERIOD;
                    break;
                case ',':
                    input.U.ki.wVk = VirtualKeyShort.OEM_COMMA;
                    break;
                default:
